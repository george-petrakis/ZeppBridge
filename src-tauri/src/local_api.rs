...
#[tauri::command]
pub fn reveal_local_api_token(state: tauri::State<'_, LocalApi>) -> Result<String, String> {
    state.0.reveal_token()
}

#[tauri::command]
pub fn rotate_local_api_token(state: tauri::State<'_, LocalApi>) -> Result<String, String> {
    state.0.rotate_token()
}
